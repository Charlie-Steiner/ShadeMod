...
public class CallOfTheGravePower extends AbstractPower {
	
    public static final String POWER_ID = "Shade:CallOfTheGravePower";
    public static final String NAME = "Potency";
    public static PowerType POWER_TYPE = PowerType.BUFF;
    public static final String IMG = "powers/call_of_the_grave";
    ...
    public void atStartOfTurn() {
    	...
    	for(int i=0;i<this.amount;i++) {
    		...
    		AbstractDungeon.actionManager.addToBottom(new PlayRandomFromExhaustAction(AbstractCard.CardType.SKILL, false));
    	}
    }
